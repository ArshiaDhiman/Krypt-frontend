...
const Services = () => {
  return (
    <div className="flex md:flex-row flex-col w-full justify-center items-center gradient-bg-services">
      <div className="flex flex-col mf:flex-row items-center justify-between md:p-20 p-y">
      ...
      <div className="flex-1 flex flex-col justify-start items-center">
        <ServiceCard
          ...
          subtitle="Security is gauranted. We always maintain privacy and maintain the quality of our products."
        />
        <ServiceCard
          color="bg-[#8945F8]"
